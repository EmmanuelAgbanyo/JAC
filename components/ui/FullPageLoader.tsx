...
const FullPageLoader = ({ message = "Loading..." }: FullPageLoaderProps) => {
  return (
    <div className="fixed inset-0 bg-secondary z-[100] flex flex-col items-center justify-center">
      ...
      <p className="text-xl font-medium text-gray-700 animate-subtle-pulse">{message}</p>
    </div>
  );
};
